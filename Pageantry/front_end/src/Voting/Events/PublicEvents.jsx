              ...
              <div className="event-card-content">
                ...
                <div className="event-info">
                  {event.start_time && (
                    <div className="info-item">
                      ...
                      <span className="value">This Event Started On {new Date(event.start_time).toLocaleDateString()}</span>
                    </div>
                  )}
                  {event.end_time && (
                    <div className="info-item">
                      <span className="label">Ends:</span>
                      <span className="value"> This Event Ends On {new Date(event.end_time).toLocaleDateString()}</span>
                    </div>
                  )}
                  <div className="info-item">
                ...
                <div className="event-actions">
                  ...
                  <button
                    ...
                    onClick={() => navigate(`/vote/${event.id}/results`)}
                  >
                    View Results
                  </button>
                </div>
